...
**Note** Mind that content extensions that need to be linked to, like the [Blog](https://greencheap.net/marketplace/package/greencheap/blog) and [Portfolio](https://greencheap.com/marketplace/package/greencheap/portfolio), can be found under _Not Linked_, as well, upon first installing them.
...
To create a new page, hit the _Add Page_ button in the top right hand corner and select the type of page you would like to create. GreenCheap comes with a few pre-defined types – any extension can add new types to that list. You can also edit existing pages by clicking on their title in the site tree. This will lead you to an edit screen, which looks different depending on the type of the item you're creating.
...
GreenCheap comes with the pre-defined widget types _Menu_, _Text_ and _Login_; extensions can add widget types of their own.
